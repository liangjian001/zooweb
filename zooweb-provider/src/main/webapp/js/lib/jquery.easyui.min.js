...
var _899aa=$('<a href="javascript:void(0)" class="datebox-current" style="padding-left:50px;"></a>').html(opts.clearText).appendTo(_898);//add by huangq 
